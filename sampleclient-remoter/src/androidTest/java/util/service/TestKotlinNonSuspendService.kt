...
class TestKotlinNonSuspendService2 {

    private lateinit var service: ISampleNonSuspendKotlinService2

    @Before
    fun setup() {
        service = ISampleKotlinService_Proxy(InstrumentationRegistry.getContext(), SERVICE_INTENT).getNonSuspendInterface2()
    }
